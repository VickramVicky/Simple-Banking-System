...
if ($result->num_rows > 0) {
    ...
    echo "<thead><th>Sender</th> <th>Recipent</th> <th> Amount Transferred</th> </thead>";
    while($row = $result->fetch_assoc()) {

    echo "<tbody><tr>"."<td>". $row["id"]."</td>"."<td>". $row["name"]."</td>"."<td>". $row["amount"]."</td>". "</tr></tbody>";
    }
} else {
    echo "0 results";
}
...
mysqli_close($conn);
    ...
    <a style="margin-left:16cm;" href="index.php" class="button">Customers</a>
